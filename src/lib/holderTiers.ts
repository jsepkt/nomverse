...
export const HOLDER_TIERS: Record<HolderTier, HolderPerks> = {
  fish: {
    ...
    hasCrown: false,
    accentColor: "#94A3B8",
    description: "Standard arcade experience. 3 Lives, 10 min regen.",
  },
  shrimp: {
    tier: "shrimp",
    label: "Shrimp Bag",
    ...
    hasCrown: false,
    accentColor: "#38BDF8",
    description: "Hold 100k+ $NOM: +2 Extra Lives (5 total) & 5-min fast life regen!",
  },
  dolphin: {
    tier: "dolphin",
    label: "Dolphin Bag",
  ...
  whale: {
    ...
    hasCrown: true,
    accentColor: "#F59E0B",
    description: "Hold 5M+ $NOM: 1.5x Score, 2x Raid Boss Damage, 6 Lives, & Golden Royal Crown!",
  },
};
