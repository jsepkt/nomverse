...
export const ArcadeJukebox: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 p-2 rounded-2xl bg-slate-950/90 border border-emerald-500/30 shadow-[0_0_25px_rgba(20,241,149,0.15)] backdrop-blur-md">
        {/* Play / Pause */}
        <button
          onClick={togglePlay}
